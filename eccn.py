...
def fetch_data_from_zoho():
    ...
    url = "https://analyticsapi.zoho.com/api/ashutosh@raptorsupplies.com/Zoho%20CRM%20Analytics/Report%20for%20ECCN?ZOHO_ACTION=EXPORT&ZOHO_OUTPUT_FORMAT=XML&ZOHO_ERROR_FORMAT=XML&ZOHO_API_VERSION=1.0"
...
def sort_and_append_to_gsheets(zoho_df, gsheets_df, sheet_name, worksheet_name, json_credentials_path):
    ...
    # Sort the dataframe by 'Date of Order Received' (descending) and 'Raptor Invoice' (ascending)
...
if __name__ == "__main__":
    ...
    gsheets_df = fetch_data_from_gsheets('Grainger / MCM invoice products', 'Non -Grainger/MCM', 'divine-arcade-406611-e0729e40870d.json')

    # Sort, combine, and append all rows (Zoho + Google Sheets) to Google Sheets
    sort_and_append_to_gsheets(zoho_df, gsheets_df, 'Grainger / MCM invoice products', 'Non -Grainger/MCM', 'divine-arcade-406611-e0729e40870d.json')